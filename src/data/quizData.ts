...
{
  question: "Տանը ջեռուցման համար օգտագործում եք՝",
  icon: "🔥",
  options: [
    { text: "Չեմ ջեռուցում", co2Value: 0 },
    { text: "Գազ", co2Value: 250 },
    { text: "Էլեկտրականություն", co2Value: 150 },
    { text: "Փայտ կամ ածուխ", co2Value: 500 }
  ]
},
{
  question: "Շաբաթվա ընթացքում քանի անգամ եք մսամթերք օգտագործում?",
  icon: "🥩",
  options: [
    { text: "Չեմ օգտագործում", co2Value: 0 },
    { text: "1-2 անգամ", co2Value: 300 },
    { text: "3-5 անգամ", co2Value: 800 },
    { text: "Ամեն օր", co2Value: 1500 }
  ]
},
{
  question: "Տպում եք թղթային փաստաթղթեր՝",
  icon: "🖨️",
  options: [
    { text: "Շատ հազվադեպ", co2Value: 1 },
    { text: "Օրական 1-2 էջ", co2Value: 10 },
    { text: "Օրական 3-5 էջ", co2Value: 30 },
    { text: "5 էջից ավելի", co2Value: 60 }
  ]
},
{
  question: "Տան պատուհանները՝",
  icon: "🪟",
  options: [
    { text: "Երկշերտ ապակի", co2Value: 10 },
    { text: "Սովորական ապակի", co2Value: 30 },
    { text: "Չեն փակվում լավ", co2Value: 50 }
  ]
}
];
